...
SECRET_KEY = 'django-insecure-#wfz)sq0ya&bi=0!qjqmc1*h92#+m@*^f_3qe!@#0q(b^v=1la'
...
EMAIL_HOST_USER = 'mariaakhtar358@gmail.com'
EMAIL_HOST_PASSWORD = 'ozwnewzjpufqdzyh'
EMAIL_PORT = 587

LOGIN_URL = 'http://localhost:8006/users/login'
